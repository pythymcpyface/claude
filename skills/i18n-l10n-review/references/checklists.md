# i18n-l10n-review — Detailed Checklists

Full checklist tables, search patterns, and per-category guidance for i18n-l10n-review. SKILL.md routes here when running the review workflow.
