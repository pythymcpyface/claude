...
If working on:
- **Database/migrations** → Read `docs/skill-references/extended/database-integrity.md`
- **Algorithm changes** → Read `docs/skill-references/extended/algorithm-validation.md`
- **Error handling systems** → Read `docs/skill-references/extended/error-classification-recovery.md`
- **Performance tuning** → Read `docs/skill-references/extended/adaptive-optimization.md`
